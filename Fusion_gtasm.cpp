...
public:
    FusionGtasm()
    {
        pubLaserOdometry = nh.advertise<nav_msgs::Odometry>("/leg_odom_a", 1000);
        subLaserOdometry = nh.subscribe<nav_msgs::Odometry>("/leg_odom", 1000, &FusionGtasm::laserOdometryHandler, this);
    ...
    void run()
    {
        ...
        else
        {
            ...
            initialEstimate.insert(size, Pose3(Rot3::RzRyRx(transformMapped[0], transformMapped[1], transformMapped[2]),
                                                                         Point3(transformMapped[3], transformMapped[4], transformMapped[5])));
        }
